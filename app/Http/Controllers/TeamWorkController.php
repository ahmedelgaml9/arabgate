...
//=========== add by my ==========//
use App\Http\Requests\TeamWorkRequest;  //============ request for this controller ==========//
use App\Teamwork;   //========= admin model =============//

class TeamWorkController extends Controller {

    //=======  request and model and view file =============//
    public function __construct(TeamWorkRequest $request, Teamwork $model) {
        $this->request = $request;
        $this->model = $model;
        $this->view = 'admin/teamwork/';
    }
