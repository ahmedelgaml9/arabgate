...
@section('content')
<a class="btn-floating btn-large waves-effect waves-light red waves-light btn modal-trigger"  href="{{ url('controll/tags/create') }}"><i class="material-icons">add</i></a>
    ...
    <div class="card-content">
        ...
        <table class="responsive-table bordered">
            <thead>
                <tr>
                    <th data-field="id">#</th>
                    <th data-field="company">Tag</th>
                    <th data-field="company">Blog_id</th>
