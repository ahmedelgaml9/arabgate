...
<tr id="trow_{{ $row->id }}">
    ...
    <td><img src="{{  asset('admin-assets/images/tag/'.$row->photo) }}" width="100" height="70"/></strong></td>
<td><strong>{{  $row->tag}}</strong></td>

    <a class="btn btn-default btn-rounded btn-sm" href="{{ url('controll/slider/'.$row->id.'/edit') }}" ><span class="fa fa-pencil"></span></a>
