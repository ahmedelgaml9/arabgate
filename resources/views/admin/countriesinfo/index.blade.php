...
@section('content')
<a class="btn-floating btn-large waves-effect waves-light red waves-light btn modal-trigger"  href="{{ url('controll/countryinfo/create') }}"><i class="material-icons">add</i></a>
<div class="card invoices-card">
    <div class="card-content">
        ...
        <table class="responsive-table bordered">
            ...
            <tbody class="data">
                @include('admin.countriesinfo.loop')
            </tbody>
        </table>
        {!! $rows->render() !!}
    </div>
